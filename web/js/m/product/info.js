...
var product_info_ops = {
    ...
    eventBind:function(){
        $(".fav").click( function(){
            ...
            $.ajax({
                url:common_ops.buildWebUrl("/product/fav"),
                type:'POST',
                data:{
        ...
        $(".add_cart_btn").click( function() {
            $.ajax({
                url:common_ops.buildWebUrl("/product/cart"),
                type:'POST',
                data:{
                    act:'set',
                    book_id:$(this).attr("data"),
        ...
        $(".order_now_btn").click( function(){
            window.location.href = common_ops.buildWebUrl("/product/order",{ 'id':$(this).attr("data"), quantity:$(".quantity-form input[name=quantity]").val() } )
        });
    ...
    updateViewCount:function(){
        $.ajax({
            url:common_ops.buildWebUrl("/product/ops"),
            type:'POST',
            data:{
                act:'view_count',
