...
<div class="layui-col-md8">
      <div class="fly-panel" style="margin-bottom: 0;">
        ...
        <ul class="fly-list">  
          ...
          <li>
            <a href="<?=UrlService::buildFrontUrl('/user/home',['id'=>$_item['user_id']])?>" class="fly-avatar">
              <img src="<?=UrlService::buildPicUrl( "avatar",$_item['avatar'] );?>" alt="<?=$_item['username'];?>">
            </a>
            <h2>
              <a class="layui-badge"><?=$_item['cate_name'];?></a>
              <a href="<?=UrlService::buildFrontUrl('/share/info',['uuid'=>$_item['uuid']])?>"><?=$_item['title'];?></a>
            </h2>
            <div class="fly-list-info">
              <a href="<?=UrlService::buildFrontUrl('/user/home',['id'=>$_item['user_id']])?>" link>
                <cite><?=$_item['username'];?></cite>
                <!--
