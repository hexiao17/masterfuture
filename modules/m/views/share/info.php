...
StaticSerivce::includeAppJsStatic( "/js/m/share/info.js",\app\assets\MAsset::className() );
      ...
      <div class="fly-panel detail-box">
        ...
        <div class="detail-about">
          ...
          <div class="detail-hits" id="LAY_jieAdmin" data-id="123">
            ...
            <span class="layui-btn layui-btn-xs jie-admin" type="edit"><a href="<?=UrlService::buildMUrl('/share/set',['id'=>$share_info['uuid']])?>">编辑此贴</a></span>
          </div>
        </div>
        ...
        <?php if($replys):?>
          ...
          <li data-id="111" class="jieda-daan">
            ...
            <div class="detail-about detail-about-reply">
              <a class="fly-avatar" href="<?=UrlService::buildMUrl('/user/home',['id'=>$_item['user_id']])?>">
            ...
            <div class="jieda-reply">
              ...
              <div class="jieda-admin"> 
                <?php 
                	...
                	if(!$_item['isAccept'] ){
                		//reply 拥有者可以编辑，删除
                	    if($_item['user_id'] == $current_user['id']){
                			echo '<span type="edit">编辑</span>';                			 
                		}
                		//task 拥有者可以删除，采纳
                		if($share_info['created_user']==$current_user['id']){
                		//	echo '<span type="del">删除</span>';
                			echo '<span class="jieda-accept" type="accept" data="'.$reply['id'].'">采纳/屏蔽</span>';                			 
                		}                		
