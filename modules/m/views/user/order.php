...
StaticSerivce::includeAppJsStatic( "/js/web/user/order.js",\app\assets\WebAsset::className() );
$this->title = "你的订单.".Yii::$app->params['title'];
?>
...
<div class="order_box mg-t20">
	...
	<ul class="order_list">
		...
		<li>
            ...
            <a style="display: block;position: absolute;bottom: 1rem;right: 1rem;" class="button"   href="<?=UrlService::buildWebUrl("/user/comment_set",[ 'pay_order_id' => $_item['id'],'book_id' => $_item_info['book_id'] ]);?>">我要评论</a>
            <?php endif;?>
		</li>
		<?php endforeach;?>
	</ul>
