...
<div class="layui-col-md8">
      <div class="fly-panel">
        ...
        <ul class="fly-list">
          ...
          ?>	
          <li>
            <a href="<?=UrlService::buildMUrl('/user/info',['id'=>$_item['user_id']]);?>" class="fly-avatar  ">
              <img src="<?=UrlService::buildPicUrl( "avatar",$_item['avatar'] );?>" alt="<?=$_item['username']; ?>">
            </a>
            <h2>
              <a class="layui-badge"><?=$_item['cate_name'];?></a>
              <a href="<?=UrlService::buildMUrl('/task/info',['id'=>$_item['id']]);?>"><?php echo $_item['title'];?></a>               
            </h2>
            <div class="fly-list-info  ">
              <a href="<?=UrlService::buildMUrl('/user/info',['id'=>$_item['user_id']]);?>"  link>
      ...
      <div class="fly-panel" style="margin-bottom: 0;">
        ...
        <div class="fly-panel-title fly-filter tab_select_group"  selectid="<?=$group;?>">
          <a class="group_1" href="<?=UrlService::buildMUrl('/task/index',['group'=>1]); ?>"  >今日</a>
          <span class="fly-mid"></span>
          <a class="group_2" href="<?=UrlService::buildMUrl('/task/index',['group'=>2]); ?>">本周</a>
          <span class="fly-mid"></span>
          <a class="group_3" href="<?=UrlService::buildMUrl('/task/index',['group'=>3]); ?>">本月</a>
          <span class="fly-mid"></span>
          <a class="group_4" href="<?=UrlService::buildMUrl('/task/index',['group'=>5]); ?>">本年</a>
          <span class="fly-mid"></span>
          <a  href="<?=UrlService::buildMUrl('/task/index',['statu'=>1]); ?>">已完成</a>
