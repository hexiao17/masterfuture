...
<!-- 通过yii指定方法渲染公共部分 -->
<?=Yii::$app->view->renderFile("@app/modules/admin/views/common/tab_brand.php",["current"=>"info"]);?>
<div class="row m-t">
		...
		<dl class="dl-horizontal">
			...
			<dd>
				<img class="img-circle circle-border"
					src="<?=UrlService::buildPicUrl("brand", $info['logo']);?>"
			...
			<dd>
				<a href="<?=UrlService::buildAdminUrl('/brand/set');?>"
					class="btn btn-outline btn-primary btn-w-m">编辑</a>
			</dd>
		</dl>
	</div>
</div>
