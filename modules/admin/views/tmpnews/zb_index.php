...
StaticSerivce::includeAppJsStatic( "/js/admin/tmpnews/zbindex.js",\app\assets\AdminAsset::className() );
?>

<?php echo \Yii::$app->view->renderFile("@app/modules/admin/views/common/tab_tmpnews.php", ['current' => 'zb']); ?>
...
<div class="row">
    <div class="col-lg-12">
        <form class="form-inline wrap_search">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a class="btn btn-w-m btn-outline btn-primary pull-right" href="<?=UrlService::buildAdminUrl("/zbnews/set");?>">
			...
			<?php if( $list ):?>
				<?php foreach( $list as $_item ):?>
                    ...
                    <td align="center"><input type="checkbox"  name="checkbox" value="<?=$_item['id'];?>" /><?=$_item['id'];?></td>
                        ...
                        <td><?= ConstantMapService::$zbnews_tmp_att_type_mapping[$_item['attach_has']] ;?></td>                      
                        <td><?= $_item['updatetime'];?></td>
                        <td>
                            <a  href="<?=UrlService::buildAdminUrl("/tmpnews/zb_info",[ 'id' => $_item['id'] ] );?>">
                                <i class="fa fa-eye fa-lg"></i>
                            </a>
							<?php if( $_item['statu'] ):?>
                                <a class="m-l" href="<?=UrlService::buildAdminUrl("/zbnews/set",[ 'tmpnews_id' => $_item['id'],'type'=>'zb' ]);?>">
