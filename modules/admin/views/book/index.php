...
<div class="row">
    <div class="col-lg-12">
        <form class="form-inline wrap_search">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a class="btn btn-w-m btn-outline btn-primary pull-right" href="<?=UrlService::buildAdminUrl("/book/set");?>">
			...
			<?php if( $list ):?>
				<?php foreach( $list as $_item ):?>
                    <tr>
                        ...
                        <td><?= $_item['origin_price'] ;?></td>
                        <td><?= $_item['price'] ;?></td>
                        <td><?= $_item['stock'] ;?></td>
                        <td><?= $_item['tags'];?></td>
                         <td><?= $_item['role_name'];?></td>
                        <td>
                            <a  href="<?=UrlService::buildAdminUrl("/book/info",[ 'id' => $_item['id'] ] );?>">
                                <i class="fa fa-eye fa-lg"></i>
                            </a>
							<?php if( $_item['status'] ):?>
                                <a class="m-l" href="<?=UrlService::buildAdminUrl("/book/set",[ 'id' => $_item['id'] ]);?>">
