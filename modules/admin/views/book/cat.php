...
StaticSerivce::includeAppJsStatic( "/js/admin/book/cat.js",\app\assets\AdminAsset::className() );
?>
...
<div class="row">
	<div class="col-lg-12">
		<form class="form-inline wrap_search">
			...
			<div class="row">
				<div class="col-lg-12">
					<a class="btn btn-w-m btn-outline btn-primary pull-right" href="<?=UrlService::buildAdminUrl("/book/cat_set");?>">
		...
		<table class="table table-bordered m-t">
            ...
            <?php if( $list ):?>
                ...
                <tr>
                    ...
                    <td>
                        <?php if( $_item['status'] ):?>
                            <a class="m-l" href="<?=UrlService::buildAdminUrl("/book/cat_set",[ 'id' => $_item['id'] ]);?>">
