...
StaticSerivce::includeAppJsStatic( "/plugins/chart.js",\app\assets\AdminAsset::className() );
StaticSerivce::includeAppJsStatic( "/js/admin/dashboard/index.js",\app\assets\AdminAsset::className() );
?>
