...
<?php echo \Yii::$app->view->renderFile("@app/modules/admin/views/common/tab_account.php", ['current' => 'comment']); ?>
			...
			<?php if( $list ):?>
				<?php foreach( $list as $_item ):?>
					...
					<td>
						...
						src="<?= UrlService::buildPicUrl("avatar",$_item['member_info']['avatar']) ;?>"
