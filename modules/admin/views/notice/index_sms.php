...
<div class="row">
    <div class="col-lg-12">
        <form class="form-inline wrap_search">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a class="btn btn-w-m btn-outline btn-primary pull-right" href="<?=UrlService::buildAdminUrl("/notice/set_sms");?>">
			...
			<?php if( $list ):?>
				<?php foreach( $list as $_item ):?>
                    <tr>
                        ...
                        <td><?= $_item['return_msg'] ;?></td>
                        <td><?= $_item['template_id'] ;?></td>
                         <td><?= $_item['send_user'] ;?></td>
                      
                         <td><?=ConstantMapService::$notice_sms_status_mapping[$_item['sms_status']];?></td>
                          <td><?=ConstantMapService::$notice_sms_type_mapping[$_item['type']];?></td>
