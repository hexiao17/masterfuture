			...
			<div class="col-lg-12">
				<div class="m-b-md">
					<?php if( $info && $info['status'] ):?>
						<a class="btn btn-outline btn-primary pull-right" href="<?=UrlService::buildAdminUrl("/zbnews/set",[ 'id' => $info['id'] ]);?>">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<p>
					<small>附件下载：</small>
					<ul>
					<?php foreach ($attachs as $_e):?>
						<li><a href="#"><?=$_e['attach_name'];?></a></li>
					<?php endforeach;?>
					</ul>
				</p>
				<?php endif;?>
