...
StaticSerivce::includeAppJsStatic( "/js/admin/zbnews/index.js",\app\assets\AdminAsset::className() );
?>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <table class="table table-bordered m-t">
            ...
            <tr>
            	<th>编辑人</th>
                <th class="applog_table-td40">新闻标题</th>               
                <th class="applog_table-td20">发布单位</th>
                <th class="applog_table-td10">发布时间</th>
                <th class="applog_table-td10">关键字</th>
                <th>操作</th>
            </tr>
            </thead>
            <tbody>
			<?php if( $list ):?>
				<?php foreach( $list as $_item ):?>
                    <tr>
                    <td><?= $_item['admin_user'];?></td>
                        <td><?= $_item['title'];?></td>                         
                        <td><?= $_item['pub_company'] ;?></td>
                        <td><?= $_item['created_time'] ;?></td>
                        <td><?= $_item['tags'];?></td>
                        <td>
                            <a  href="<?=UrlService::buildAdminUrl("/zbnews/info",[ 'id' => $_item['id'] ] );?>">
                                <i class="fa fa-eye fa-lg"></i>
                            </a>
							<?php if( $_item['status'] ):?>
                                <a class="m-l" href="<?=UrlService::buildAdminUrl("/zbnews/set",[ 'id' => $_item['id'] ]);?>">
