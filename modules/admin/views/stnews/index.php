...
StaticSerivce::includeAppJsStatic( "/js/admin/stnews/index.js",\app\assets\AdminAsset::className() );
?>
			...
			<?php if( $list ):?>
				<?php foreach( $list as $_item ):?>
                    ...
                    <td><?= $_item['admin_user'];?></td>
                        ...
                        <td><?= $_item['tags'];?></td>
                        <td>
                            <a  href="<?=UrlService::buildAdminUrl("/stnews/info",[ 'id' => $_item['id'] ] );?>">
                                <i class="fa fa-eye fa-lg"></i>
                            </a>
							<?php if( $_item['status'] ):?>
                                <a class="m-l" href="<?=UrlService::buildAdminUrl("/stnews/set",[ 'id' => $_item['id'] ]);?>">
