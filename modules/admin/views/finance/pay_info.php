...
StaticSerivce::includeAppJsStatic( "/js/admin/finance/pay_info.js",\app\assets\AdminAsset::className() );
?>
								...
								<table class="table table-striped">
									...
									<?php foreach( $pay_order_items as $_order_item ):?>
										<tr>
											...
											<td><a href="<?=UrlService::buildAdminUrl('/member/orderupdate',['member_id'=>$_order_item['member_id']]);?>">查看详情</a></td>
										</tr>
									<?php endforeach;?>
									</tbody>
								</table>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">确认发货(邮件发票)</h4>
            </div>
